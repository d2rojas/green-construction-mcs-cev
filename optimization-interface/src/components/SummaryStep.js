...
const SummaryStep = ({ formData, onGenerateFiles, onGenerateAndOptimize, isGenerating }) => {
    ...
    <div>
      ...
      <Row>
        ...
        <Col lg={4}>
          ...
          <Card className="mb-4">
            <Card.Header>
              <h5>🚀 Generate Files & Optimize</h5>
            </Card.Header>
            <Card.Body>
              <p className="small text-muted mb-3">
                Choose how you want to proceed with your optimization:
              </p>
              
              {/* First Button: Generate Files Only */}
              <Button 
              ...
              {/* Second Button: Generate and Optimize */}
              <Button 
                variant="success" 
                size="lg" 
                className="w-100"
              ...
              >
                {isGenerating ? (
                  <>
                    <span className="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span>
                    Generating & Starting Optimization...
                  </>
                ) : (
                  <>
              ...
              <div className="mt-3">
                <p className="small text-muted mb-1">
                  <strong>Option 1:</strong> Generate CSV files for manual download only
                </p>
                <p className="small text-muted">
                  <strong>Option 2:</strong> Generate files and run optimization automatically
                </p>
              </div>
            </Card.Body>
          </Card>
